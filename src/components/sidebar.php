...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <?php
        // Fetch active teams to display in sidebar
        $sidebarTeams = [];
        try {
        ...
        if (!empty($sidebarTeams)): ?>
            <div class="sidebar-section-header">
                ...
                <i class="fa-solid fa-plus-circle"
                    style="font-size: 1rem; color: #cbd5e1; cursor: pointer; transition: color 0.2s;"
                    onmouseover="this.style.color='#10b981'" onmouseout="this.style.color='#cbd5e1'"
                    onclick="window.location.href='/manage_teams.php'"></i>
            </div>
            <div class="sidebar-teams-list" style="display: flex; flex-direction: column; gap: 4px; padding: 0 0.65rem;">
                <?php foreach ($sidebarTeams as $sTeam):
                    ...
                    $isHighlighted = isset($_GET['highlight']) && $_GET['highlight'] == $sTeam['id'];
                    ?>
                    <?php
                    ...
                    <a href="/team_members.php?id=<?php echo $sTeam['id']; ?>"
                        class="nav-item team-item <?php echo $isHighlighted ? 'active' : ''; ?>"
